...
function useFormState(props) {
  ...
  useSubscribe({
    disabled,
    callback: (formState2) => (!_name.current || !formState2.name || convertToArrayPayload(_name.current).includes(formState2.name)) && shouldRenderFormState(formState2, _localProxyFormState.current) && updateFormState(Object.assign(Object.assign({}, control._formState), formState2)),
      ...
      if (ref) {
        ...
        field2 = {
          _f: isRadioOrCheckbox ? Object.assign(Object.assign({}, field2._f), { refs: [
            ...compact(field2._f.refs || []).filter((ref2) => isHTMLElement(ref2) && document.contains(ref2)),
            fieldRef
...
function useWatch(props) {
  ...
  useSubscribe({
    ...
    callback: ({ name: name2 }) => {
      if (!_name.current || !name2 || convertToArrayPayload(_name.current).some((currentName) => name2 && currentName && (name2.startsWith(currentName) || currentName.startsWith(name2)))) {
        control._stateFlags.mount = true;
