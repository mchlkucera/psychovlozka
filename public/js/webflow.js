               ...
               (t.init = function (t, e, n, r) {
                  ...
                  (t.fallback = function (t) {
                     ...
                     (t = this.convert(t, this.type)),
                        this.auto &&
                           ("auto" == n &&
                              (n = this.convert(this.get(), this.type)),
                           "auto" == t && (t = e.call(this))),
                        (this.tween = new U({
                           from: n,
                           to: t,
                           ...
                           (function (t) {
                              ...
                              st.forEach(function (n) {
                                 window.addEventListener(n, e),
                                    t.dispatch(
                                       (0, y.eventListenerAdded)(window, [n, e])
                                    );
                              }),
                                 e();
                           })(t);
            ...
            f
               ? (function (t, e) {
                    ...
                    t.dispatch((0, y.instanceStarted)(e, 0)),
                       t.dispatch(
                          (0, y.animationFrameChanged)(performance.now(), n)
                       ),
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
         ...
         (e.shouldNamespaceEventParameter = function (t, e) {
            ...
            return (
               ...
               (t === h.EventTypeConsts.MOUSE_MOVE &&
                  n === h.EventBasedOn.ELEMENT)
            );
         }),
      ...
      var c,
         ...
         dt = function (t) {
            return function (e) {
               ...
               return (
                  (n && y && (E || m.inBounds !== n.inBounds) && t(e, m)) || m
               );
            };
         },
         pt = function (t) {
               ...
               p || (p = "w-dropdown-toggle-" + e),
                  ...
                  f.links.each(function (t, e) {
                     e.hasAttribute("tabindex") ||
                        ...
                        u.test(e.hash) &&
                           e.addEventListener("click", L.bind(null, f));
                  }),
                  f.el.off(v),
                  f.toggle.off(v),
                  f.nav && f.nav.off(v);
                     ...
                     t
                        ...
                        .done(function (t) {
                           (n.success =
                              ...
                              n.success ||
                                 console.info("MailChimp error: " + t.msg),
                              A(n);
                        })
                        .fail(function () {
                           A(n);
   ...
   events: {
      e: {
         ...
         target: {
            ...
            originalId:
               "6152c668a5195583854274c3|f09539e8-9b75-0bb5-153d-0c4a835d5f83",
            appliesTo: "CLASS",
         },
         targets: [
            {
      ...
      "e-7": {
         ...
         action: {
            ...
            instant: false,
            config: { actionListId: "flyInLeft", autoStopEventId: "e-8" },
         },
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "6152c668a5195583854274c3|fb8c37ad-e3e0-2510-7232-070bf911ca10",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-9": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            selector: ".app-list__item.has-arrow",
            originalId:
               "61584f42c5ddbe864f6127f3|b27bf87f-2483-a10a-11b6-54cd5a09a250",
            appliesTo: "CLASS",
         },
         targets: [
            {
      ...
      "e-11": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "61584f42c5ddbe864f6127f3|07f1981d-8fa3-adb4-0456-613f12f89cfe",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-15": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "61584f42c5ddbe864f6127f3|4ba702ea-9bb6-32ab-200d-852df43c0c36",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-19": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "61584f42c5ddbe864f6127f3|c5d8c0a0-3753-1e6a-5a38-51d572925a16",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-21": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "61584f42c5ddbe864f6127f3|ce69e2d8-14c0-be53-25c3-90692caf225f",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-23": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "61584f42c5ddbe864f6127f3|a1445974-fc15-3356-014d-80d6c0256724",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-25": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "61584f42c5ddbe864f6127f3|d11e926a-ae1a-74c7-2649-a3960900bfa4",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-27": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "61584f42c5ddbe864f6127f3|6ca88332-4d7f-e8b3-0a5c-14454d2a07d0",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-29": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "61584f42c5ddbe864f6127f3|c7c22a61-790d-5831-b7e9-0aef7a968adc",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
      ...
      "e-31": {
         ...
         mediaQueries: ["main", "medium", "small", "tiny"],
         target: {
            id: "61584f42c5ddbe864f6127f3|d4b1d005-16f3-ccce-ed1e-ee1b30a0c65b",
            appliesTo: "ELEMENT",
            styleBlockIds: [],
         },
         targets: [
               ...
               actionItems: [
                  {
                     ...
                     config: {
                        ...
                        target: {
                           ...
                           selectorGuids: [
                              "93fcbc9a-c7d8-6cdc-3f94-9b6fe104e17e",
                           ],
                        },
                        heightValue: 0,
                        widthUnit: "PX",
                  ...
                  },
                  {
                     ...
                     config: {
                        ...
                        target: {
                           ...
                           selectorGuids: [
                              "93fcbc9a-c7d8-6cdc-3f94-9b6fe104e179",
                              "93fcbc9a-c7d8-6cdc-3f94-9b6fe104e180",
                           ],
                        },
                        zValue: 0,
                        xUnit: "DEG",
                  ...
                  },
                  {
                     ...
                     config: {
                        ...
                        target: {
                           ...
                           selectorGuids: [
                              "93fcbc9a-c7d8-6cdc-3f94-9b6fe104e17c",
                           ],
                        },
                        globalSwatchId: "",
                        rValue: 0,
               ...
               actionItems: [
                  {
                     ...
                     config: {
                        ...
                        target: {
                           ...
                           selectorGuids: [
                              "93fcbc9a-c7d8-6cdc-3f94-9b6fe104e179",
                              "df5de286-6925-8136-74b4-802d9e46e50a",
                           ],
                        },
                        xValue: -12,
                        xUnit: "px",
